...
//    @PatchMapping("/{id}")
//    public ResponseEntity<?> partialUpdateUser(@PathVariable Long id, @RequestBody UserDao userDao) {
//        try {
...
//                existingUserDao.setFirstName(userDao.getFirstName());
//            }
//            if (userDao.getLastName() != null) {
//                existingUserDao.setLastName(userDao.getLastName());
//            }
//            if (userDao.getEmail() != null) {
//                existingUserDao.setEmail(userDao.getEmail());
//            }
//            if (userDao.getAge() != null) {
//                existingUserDao.setAge(userDao.getAge());
//            }
//            if (userDao.getRoles() != null) {
//                existingUserDao.setRoles(userDao.getRoles());
//            }
//            if (userDao.getPassword() != null && !userDao.getPassword().trim().isEmpty()) {
//                existingUserDao.setPassword(userDao.getPassword());
//            }
//
...
//    }
    ...
    public ResponseEntity<?> partialUpdateUser(@PathVariable Long id, @RequestBody Map<String, Object> updates) {
        try {
            ...
            // Создаем UserDao из существующего пользователя
            UserDao existingUserDao = new UserDao(existingUser);
            ...
            if (updates.containsKey("roles")) {
                // Обработка ролей - преобразуем List в String[]
