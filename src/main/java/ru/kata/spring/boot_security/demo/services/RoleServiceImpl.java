...
//    }
    ...
    public Role getRoleByName(String roleName) throws IllegalStateException {
        ...
        // ОЧИСТКА ВХОДНОГО ПАРАМЕТРА - удаляем пробелы и символы новой строки
        ...
        // Используем метод без учета регистра с очищенным именем
        ...
        if (role.isPresent()) {
            ...
            // Выведем все доступные роли для отладки
